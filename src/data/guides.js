...
export const GUIDES = [
  { slug: 'css-has-selector', day: 17, cat: 'css', cluster: null, locales: L,
    title: { en: "The CSS :has() Selector: the Parent Selector, Explained", fr: "Le sélecteur CSS :has() : le sélecteur de parent, expliqué", es: "El selector CSS :has(): el selector de padre, explicado", de: "Der CSS-Selektor :has(): der Eltern-Selektor, erklärt", it: "Il selettore CSS :has(): il selettore del genitore, spiegato", pt: "O seletor CSS :has(): o seletor de pai, explicado" },
    desc: { en: "The :has() relational pseudo-class styles an element based on what it contains or what follows it - the long-awaited CSS parent selector. How it works, real examples, and browser support.", fr: "La pseudo-classe relationnelle :has() stylise un élément selon ce qu’il contient ou ce qui le suit - le sélecteur de parent CSS tant attendu. Fonctionnement, exemples concrets et support navigateur.", es: "La pseudoclase relacional :has() aplica estilos a un elemento según lo que contiene o lo que le sigue - el esperado selector de padre de CSS. Cómo funciona, ejemplos reales y compatibilidad.", de: "Die relationale Pseudoklasse :has() stylt ein Element danach, was es enthält oder was ihm folgt - der lang erwartete CSS-Eltern-Selektor. Funktionsweise, echte Beispiele und Browser-Support.", it: "La pseudo-classe relazionale :has() applica stili a un elemento in base a cosa contiene o cosa lo segue - l’atteso selettore del genitore di CSS. Come funziona, esempi reali e supporto dei browser.", pt: "A pseudo-classe relacional :has() estiliza um elemento com base no que contém ou no que o segue - o aguardado seletor de pai do CSS. Como funciona, exemplos reais e suporte dos navegadores." } },
  { slug: 'popover-api', day: 16, cat: 'html', cluster: null, locales: L,
    title: { en: "The Popover API: native popups, menus and tooltips without a library", fr: "L’API Popover : popups, menus et infobulles natifs sans bibliothèque", es: "La Popover API: popups, menús y tooltips nativos sin biblioteca", de: "Die Popover API: native Popups, Menüs und Tooltips ohne Bibliothek", it: "La Popover API: popup, menu e tooltip nativi senza librerie", pt: "A Popover API: popups, menus e tooltips nativos sem biblioteca" },
    desc: { en: "The HTML popover attribute and the Popover API let you build menus, tooltips and cards that render in the top layer, with light-dismiss and Esc handled for you - no JavaScript library needed.", fr: "L’attribut HTML popover et l’API Popover permettent de créer menus, infobulles et cartes rendus dans la couche supérieure, avec fermeture au clic extérieur et Échap gérées pour vous - sans bibliothèque JavaScript.", es: "El atributo HTML popover y la Popover API te permiten crear menús, tooltips y tarjetas que se renderizan en la capa superior, con cierre al hacer clic fuera y Esc gestionados por ti - sin biblioteca JavaScript.", de: "Das HTML-Attribut popover und die Popover API lassen dich Menüs, Tooltips und Karten bauen, die im Top-Layer rendern, mit Light-Dismiss und Esc bereits erledigt - ganz ohne JavaScript-Bibliothek.", it: "L’attributo HTML popover e la Popover API ti permettono di creare menu, tooltip e schede che vengono renderizzati nel top layer, con chiusura al clic esterno ed Esc già gestiti - senza librerie JavaScript.", pt: "O atributo HTML popover e a Popover API permitem criar menus, tooltips e cartões renderizados na camada de topo, com fecho ao clicar fora e Esc já tratados por si - sem biblioteca JavaScript." } },
